...
import { BASE_URL, downloadFile, getDownloadLink } from '../../../api/requests';
	...
	return (
		<>
			<div className='file-edit-panel'>
				<div
					className='file-edit-panel--item'
					onClick={() => onClickHandler('rename')}
					onKeyDown={() => onClickHandler('rename')}
					role='button'
					tabIndex={0}
				>
					Переименовать
				...
				<div
					className='file-edit-panel--item'
					onClick={() => onClickHandler('changeComment')}
					onKeyDown={() => onClickHandler('changeComment')}
					role='button'
					tabIndex={0}
				>
				...
				<div
					...
					onKeyDown={() => onClickHandler('download')}
					role='button'
					tabIndex={0}
				>
					Скачать
				...
				<div
					className='file-edit-panel--item'
					onClick={() => onClickHandler('getLink')}
					onKeyDown={() => onClickHandler('getLink')}
					role='button'
					tabIndex={0}
				>
